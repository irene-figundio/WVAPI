...
namespace VITBO.Services
{
    public class TripsService : ITripsService
    {
        ...
        public TripsService(HttpService httpService, IConfiguration configuration)
        {
            ...
            _apiBase = _configuration["ApiSettings:BaseUrl"] ?? "https://localhost:7275/api/";
        ...
        {
            var endpoint = $"{_apiBase}trips{(eventId.HasValue ? $"?eventId={eventId}" : "")}";
        ...
        {
            var endpoint = $"{_apiBase}trips/{id}";
            var response = await _httpService.SendHttpRequestAsync<object>(HttpMethod.Get, endpoint, sessionToken, userAgent: userAgent);
        ...
        {
            var endpoint = $"{_apiBase}stays?tripId={tripId}";
            var response = await _httpService.SendHttpRequestAsync<object>(HttpMethod.Get, endpoint, sessionToken, userAgent: userAgent);
        ...
        {
            var endpoint = $"{_apiBase}stays/{id}";
            var response = await _httpService.SendHttpRequestAsync<object>(HttpMethod.Get, endpoint, sessionToken, userAgent: userAgent);
        ...
        {
            var endpoint = $"{_apiBase}itinerarydays?tripId={tripId}";
            var response = await _httpService.SendHttpRequestAsync<object>(HttpMethod.Get, endpoint, sessionToken, userAgent: userAgent);
        ...
        {
            var endpoint = $"{_apiBase}itinerarydays/{id}";
            var response = await _httpService.SendHttpRequestAsync<object>(HttpMethod.Get, endpoint, sessionToken, userAgent: userAgent);
        ...
        {
            var endpoint = $"{_apiBase}itinerarydays";
            var response = await _httpService.SendHttpRequestAsync(HttpMethod.Post, endpoint, sessionToken, content: request, userAgent: userAgent);
            return response != null && response.IsSuccessStatusCode;
        }
        ...
        {
            var endpoint = $"{_apiBase}itinerarystops?dayId={dayId}";
            var response = await _httpService.SendHttpRequestAsync<object>(HttpMethod.Get, endpoint, sessionToken, userAgent: userAgent);
        ...
        {
            var endpoint = $"{_apiBase}itinerarystops/{id}";
            var response = await _httpService.SendHttpRequestAsync<object>(HttpMethod.Get, endpoint, sessionToken, userAgent: userAgent);
        ...
        {
            var endpoint = $"{_apiBase}itinerarystops";
            var response = await _httpService.SendHttpRequestAsync(HttpMethod.Post, endpoint, sessionToken, content: request, userAgent: userAgent);
            return response != null && response.IsSuccessStatusCode;
        }
        ...
        {
            var endpoint = $"{_apiBase}tripmusts?tripId={tripId}";
            var response = await _httpService.SendHttpRequestAsync<object>(HttpMethod.Get, endpoint, sessionToken, userAgent: userAgent);
        ...
        {
            var endpoint = $"{_apiBase}tripmusts/{id}";
            var response = await _httpService.SendHttpRequestAsync<object>(HttpMethod.Get, endpoint, sessionToken, userAgent: userAgent);
        ...
        {
            var endpoint = $"{_apiBase}tripmusts";
            var response = await _httpService.SendHttpRequestAsync(HttpMethod.Post, endpoint, sessionToken, content: request, userAgent: userAgent);
            return response != null && response.IsSuccessStatusCode;
        }
