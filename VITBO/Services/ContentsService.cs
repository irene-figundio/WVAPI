...
namespace VITBO.Services
{
    public class ContentsService : IContentsService
    {
        ...
        {
            var endpoint = $"{_apiBase}/Contents";
        ...
        {
            var endpoint = $"{_apiBase}/Contents/type/{contentType}?langId={langId}";
        ...
        {
            var endpoint = $"{_apiBase}/Contents/{id}?langId={langId}";
            var result = await _httpService.SendHttpRequestAsync(HttpMethod.Get, endpoint, token, userAgent, null);
        ...
        {
            var endpoint = $"{_apiBase}/Contents/{id}";
